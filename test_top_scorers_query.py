"""
Test retrieval breakdown with top scorers query
"""
import sys
...
print("=" * 80)
print("RETRIEVAL BREAKDOWN TEST - TOP SCORERS QUERY")
print("=" * 80)
...
print(f"Note: Players with high goals get boosted similarity scores")
embedding.close()
...
print("\n" + "-" * 80)
print("Improvement:")
print("  ✅ Stat-aware re-ranking penalizes low scorers")
print("  ✅ Boosts players with 10+ goals on 'scorer' queries")
print("  ✅ Better alignment between semantic and factual results")
