"""
Test retrieval breakdown with squad building query
"""
import sys
...
print("=" * 80)
print("RETRIEVAL BREAKDOWN TEST - SQUAD BUILDING QUERY")
print("=" * 80)

query = "i want to get attackers for my squad"
print(f"\nQuery: {query}")
print("=" * 80)
...
print(f"\nBaseline Source: get_top_scorers(FWD, 2022-23)")
baseline.close()
...
print(f"\nEmbedding Source: Vector similarity to 'attackers for squad'")
embedding.close()
...
merged_results = hybrid.retrieve(query=query, season="2022-23")
...
print(f"  Detected intent: {merged_results.get('intent', 'unknown')}")
print("  Query understanding: 'attackers' = FWD, 'for my squad' = selection query")
