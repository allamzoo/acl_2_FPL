"""
Test gameweek query through full RAG pipeline with LLM generation
"""
...
def test_gameweek_full_pipeline():
    """Test gameweek query with all 3 retrieval modes and LLM generation."""
    
    print("=" * 80)
    print("GAMEWEEK QUERY - FULL RAG PIPELINE TEST")
    print("=" * 80)
    ...
    print("OBSERVATIONS:")
    print("=" * 80)
    print("• Baseline mode: Returns GW1-specific performance (15pts, 13pts)")
    print("• Embedding modes: Add semantically similar players (season totals)")
    print("• Model 2 (MiniLM) retrieves more diverse players than Model 1 (mpnet)")
    print("• LLM should focus on GW1 performance from baseline results")
    
    print("\n✓ Full pipeline test complete")


if __name__ == "__main__":
    test_gameweek_full_pipeline()
